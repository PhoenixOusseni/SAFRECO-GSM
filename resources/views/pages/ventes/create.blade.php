...
@section('content')
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Enregistrer une Nouvelle Vente</h5>
                        ...
                        <form action="{{ route('gestions_ventes.store') }}" method="POST">
                            @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="number" class="form-control quantite-input"
                                                       name="articles[0][quantite]" placeholder="0" step="0.01" min="0.01" required>
                                            </div>
                                            <div class="col-md-2 mb-3">
                                                <label class="small">Prix Vente <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control prix-vente-input"
                                                       name="articles[0][prix_vente]" placeholder="0.00" step="0.01" min="0" required>
                                            </div>
                                            <div class="col-md-2 mb-3">
    ...
    <script>
        ...
        document.getElementById('add-article').addEventListener('click', function() {
            ...
            const newArticle = document.querySelector('.article-row').cloneNode(true);

            // R�initialiser les valeurs
            newArticle.querySelectorAll('input, select').forEach(input => {
            ...
            newArticle.querySelectorAll('[name]').forEach(field => {
                const name = field.getAttribute('name');
                field.setAttribute('name', name.replace(/\[\d+\]/, `[${articleIndex}]`));
            });
        ...
        // Fonction pour ajouter les �v�nements � une ligne d'article
