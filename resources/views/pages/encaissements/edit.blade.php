            ...
            <div class="mx-0">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Modifier l'Encaissement</li>
                    </ol>
                </nav>
            </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Modifier l'Encaissement N°{{ $encaissement->code }}</h5>
                        ...
                        <form action="{{ route('gestions_encaissements.update', $encaissement->id) }}" method="POST"
                            id="encaissementForm">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('date_encaissement', $encaissement->date_encaissement) }}"
                                            required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('mode_paiement') is-invalid @enderror"
                                            ...
                                            <option value="Espèces"
                                                {{ old('mode_paiement', $encaissement->mode_paiement) == 'Espèces' ? 'selected' : '' }}>
                                                Espèces</option>
                                            <option value="Chèque"
                                                {{ old('mode_paiement', $encaissement->mode_paiement) == 'Chèque' ? 'selected' : '' }}>
                                                Chèque</option>
                                            <option value="Virement"
                                                {{ old('mode_paiement', $encaissement->mode_paiement) == 'Virement' ? 'selected' : '' }}>
                                                Virement</option>
                                            <option value="Carte bancaire"
                                                {{ old('mode_paiement', $encaissement->mode_paiement) == 'Carte bancaire' ? 'selected' : '' }}>
                                                Carte bancaire</option>
                                            <option value="Mobile Money"
                                                {{ old('mode_paiement', $encaissement->mode_paiement) == 'Mobile Money' ? 'selected' : '' }}>
                                                Mobile Money</option>
                                        </select>
                                        @error('mode_paiement')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('vente_id') is-invalid @enderror" id="vente_id"
                                            ...
                                            <option value="{{ $encaissement->vente_id }}">
                                                {{ $encaissement->vente->numero_vente }} -
                                                {{ $encaissement->vente->client->raison_sociale ?? $encaissement->vente->client->nom }}
                                            </option>
                                        </select>
                                        @error('vente_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="client_nom" readonly
                                            value="{{ $encaissement->vente->client->raison_sociale ?? $encaissement->vente->client->nom }}">
                                        <input type="hidden" id="client_id" name="client_id"
                                            value="{{ $encaissement->vente->client_id }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('montant') is-invalid @enderror"
                                            ...
                                            value="{{ old('montant', $encaissement->vente->montant_total) }}">
                                        @error('montant')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="montant_encaisse" class="small">Montant Encaissé <span
                                                class="text-danger">*</span></label>
                                        <input type="number"
                                            class="form-control @error('montant_encaisse') is-invalid @enderror"
                                            id="montant_encaisse" name="montant_encaisse"
                                            value="{{ old('montant_encaisse', $encaissement->montant_encaisse) }}"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="reste" step="0.01"
                                            ...
                                            value="{{ old('reste', $encaissement->vente->montant_total - $encaissement->montant_encaisse) }}">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-save"></i>&nbsp; Modifier l'Encaissement
                                </button>
