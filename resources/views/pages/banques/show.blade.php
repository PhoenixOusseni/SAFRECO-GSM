...
@section('content')
    <div class="pagetitle">
        <div class="d-flex justify-content-between align-items-center">
            <div class="mx-0">
                <h1>Details de la Banque</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('gestions_banques.index') }}">Banques</a></li>
                        <li class="breadcrumb-item active">Details</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="{{ route('gestions_banques.index') }}" class="btn btn-primary">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <a href="{{ route('gestions_banques.edit', $banque->id) }}" class="btn btn-warning">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <i class="bi bi-bank"></i> Informations de la Banque
                        </h5>

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="info-group">
                                    <label class="fw-bold text-muted small">Code Banque</label>
                                    <p class="mb-0">
                                        <span class="badge bg-primary fs-6">{{ $banque->code }}</span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-group">
                                    ...
                                    <p class="mb-0">
                                        <span class="badge bg-info fs-6">{{ $banque->numero_compte }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="info-group">
                                    ...
                                    <p class="fs-5 mb-0">{{ $banque->designation }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="info-group">
                                    ...
                                    <p class="mb-0">
                                        @if ($banque->telephone)
                                            <a href="tel:{{ $banque->telephone }}" class="text-decoration-none">
                                                {{ $banque->telephone }}
                                            </a>
                                        @else
                            ...
                            <div class="col-md-6">
                                <div class="info-group">
                                    ...
                                    <p class="mb-0">
                                        @if ($banque->email)
                                            <a href="mailto:{{ $banque->email }}" class="text-decoration-none">
                                                {{ $banque->email }}
                                            </a>
                                        @else
                                            <span class="text-muted fst-italic">Non renseigné</span>
                            ...
                            <div class="col-md-6">
                                <div class="info-group">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        {{ $banque->created_at ? $banque->created_at->format('d/m/Y à H:i') : 'N/A' }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-group">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        {{ $banque->updated_at ? $banque->updated_at->format('d/m/Y à H:i') : 'N/A' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center py-4">
                            <h2 class="text-{{ $banque->solde >= 0 ? 'success' : 'danger' }} mb-1">
                                {{ number_format($banque->solde, 0, ',', ' ') }} FCFA
                            </h2>
                            @if ($banque->solde >= 0)
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('gestions_banques.edit', $banque->id) }}" class="btn btn-warning">
                                <i class="bi bi-pencil-square"></i> Modifier la Banque
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <span class="badge bg-secondary">#{{ $banque->id }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-info" role="alert">
                                <i class="bi bi-info-circle"></i> Aucun encaissement enregistré pour cette banque.
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-info" role="alert">
                                <i class="bi bi-info-circle"></i> Aucun décaissement enregistré pour cette banque.
                            </div>
                        @endif
                    </div>
                </div>
